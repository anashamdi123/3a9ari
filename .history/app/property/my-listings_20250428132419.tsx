...
import { StyleSheet, View, Text, SafeAreaView, FlatList, TouchableOpacity, Alert, ActivityIndicator, Platform } from 'react-native';
  ...
  const renderItem = ({ item }: { item: Property }) => (
    <View style={styles.listingCard}>
      <View style={styles.listingInfo}>
        ...
        <Text style={styles.listingPrice}>{item.price} ريال</Text>
