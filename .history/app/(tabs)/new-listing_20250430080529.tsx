...
export default function NewListingScreen() {
  ...
  const handlePhoneNumberChange = (value: string) => {
    ...
    // Format the number: +216 XX XXX XXX
    if (cleaned.length <= 4) {
      setPhoneNumber(cleaned);
    } else if (cleaned.length <= 6) {
      setPhoneNumber(cleaned.slice(0, 4) + ' ' + cleaned.slice(4));
    } else if (cleaned.length <= 9) {
      setPhoneNumber(cleaned.slice(0, 4) + ' ' + cleaned.slice(4, 7) + ' ' + cleaned.slice(7));
    } else {
      setPhoneNumber(cleaned.slice(0, 4) + ' ' + cleaned.slice(4, 7) + ' ' + cleaned.slice(7, 10));
    }
  };
          ...
          <View style={styles.stepContainer}>
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                maxLength={13}
              />
              <Text style={styles.helperText}>سيتم عرض رقم الهاتف للمهتمين بالعقار</Text>
            </View>
