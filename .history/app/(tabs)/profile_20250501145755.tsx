    ...
    >
      ...
      <TouchableOpacity
        style={[
          ...
          statusFilter === 'pending' && { backgroundColor: Theme.colors.warning + '20' }
        ]}
      ...
      >
        ...
        <Text style={[
          ...
          statusFilter === 'pending' && { color: Theme.colors.warning }
        ]}>
          قيد المراجعة
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        style={[
          ...
          statusFilter === 'approved' && { backgroundColor: Theme.colors.success + '20' }
        ]}
      ...
      >
        ...
        <Text style={[
          ...
          statusFilter === 'approved' && { color: Theme.colors.success }
        ]}>
          مقبول
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        style={[
          ...
          statusFilter === 'rejected' && { backgroundColor: Theme.colors.error + '20' }
        ]}
      ...
      >
        ...
        <Text style={[
          ...
          statusFilter === 'rejected' && { color: Theme.colors.error }
        ]}>
          مرفوض
        </Text>
      </TouchableOpacity>
