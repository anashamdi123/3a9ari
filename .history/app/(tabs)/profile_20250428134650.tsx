...
import { LogOut, CreditCard as Edit3, Clipboard, User as UserIcon, Save, X, Home, MapPin, DollarSign, Square } from 'lucide-react-native';
...
export default function ProfileScreen() {
  ...
  const fetchUserListings = async () => {
    ...
    try {
      ...
      Alert.alert('خطأ', 'حدث خطأ أثناء جلب العقارات');
    } finally {
      ...
      <View style={styles.propertyInfo}>
        ...
        <View style={styles.propertyDetails}>
          <View style={styles.propertyDetail}>
            ...
            <Text style={styles.propertyDetailText}>{item.location}</Text>
          </View>
          <View style={styles.propertyDetail}>
            <DollarSign size={16} color={Theme.colors.text.secondary} />
            <Text style={styles.propertyDetailText}>{item.price.toLocaleString()} {Theme.CURRENCY}</Text>
          </View>
          <View style={styles.propertyDetail}>
            <Square size={16} color={Theme.colors.text.secondary} />
            <Text style={styles.propertyDetailText}>{item.size} {Theme.AREA_UNIT}</Text>
          </View>
        </View>
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.listingsSection}>
          <View style={styles.listingsHeader}>
            <Home size={24} color={Theme.colors.text.primary} />
            <Text style={styles.listingsTitle}>عقاراتي</Text>
          </View>
