...
import { Heart, MapPin, Ruler, DollarSign, Home } from 'lucide-react-native';
    ...
    >
      ...
      <View style={styles.content}>
        <View style={styles.propertyType}>
          <Home size={14} color={Theme.colors.primary} />
          <Text style={styles.propertyTypeText}>Maisons et Villas</Text>
        </View>
        ...
        <View style={styles.footerRow}>
          ...
          <View style={styles.feature}>
            <Text style={styles.timeText}>8 hours ago</Text>
          </View>
        </View>
      </View>
    </TouchableOpacity>
